 ...
 * MC + lubricant common + the consumer mod on classpath, runs
 * {@link LubricantDataProvider}, writes JSON straight to the output directory
 * passed as {@code args[0]}.
 *
 ...
 */
public final class LubricantDataMain {

    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            System.err.println("Usage: LubricantDataMain <output-resources-dir>");
            System.exit(2);
        }
