package wd40.lubricant.api.server;
 ...
 * with no local server thread. Typical home for {@code ServerEvents}-style
 * subscribers, command registration, and any state that lives on the server tick.
 *
 * <p>List your implementations in
 * {@code META-INF/services/wd40.lubricant.api.server.ServerInit}.</p>
 *
