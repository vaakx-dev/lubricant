...
public final class Blocks implements CommonInit {
    ...
    public static final RegistrySupplier<Block> GEAR_HEAD = BLOCKS.registerNoItem("gear_head",
    ...
    public static final RegistrySupplier<Block> COUNTER = BLOCKS.register("counter",
